<script>
  ...
  function navigateTo(path) {
    ...
    selectedAnnotationType.set("news");
...
<main>
  <h1>
    Welcome to <span
      ...
      /></span
    >: an AI Data Annotation Application
  </h1>
  ...
  <p style="margin:10% 20% 0% 20%">
    ...
    prompts that instruct the AI on how to label your data, and provides
    multiple ways of exploration for you to better understand the results.<br />
  </p>
</main>
